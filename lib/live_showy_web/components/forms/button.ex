  ...
  def render(assigns) do
    ...
    <button
      ...
      class={
        ...
        "bg-default-200 text-default-700 dark:bg-default-700 dark:text-white": @kind == "default" && !@active,
        ...
        "bg-primary-200 text-primary-700 dark:bg-primary-700 dark:text-white": @kind == "primary" && !@active,
        ...
        "bg-success-200 text-success-700 dark:bg-success-700 dark:text-white": @kind == "success" && !@active,
        ...
        "bg-warning-200 text-warning-700 dark:bg-warning-700 dark:text-white": @kind == "warning" && !@active,
        ...
        "bg-danger-200 text-danger-700 dark:bg-danger-700 dark:text-white": @kind == "danger" && !@active
      }
    >
      <#slot>{@label}</#slot>
    </button>
